              ...
              <div className="col-6 col-sm-6 col-md-4 col-lg-3 col-xxl-2 py-2">
                <div className="card w-100 h-100">
                  <div className="shopping-cart">
                    <div className="image position-relative border-2">
                      <img
                        src={data.imageUrl}
                      ...
                      <div
                        className="image-overlay position-absolute m-1 border rounded"
                        style={{ cursor: "pointer" }}
                      >
                        <div className="d-flex justify-contenter-center align-items-center w-100 h-100">
                          <div>
                            {carts.find(
                              ...
                              <div className="position-absolute top-50 start-50 translate-middle">
                                ...
                                <div className="d-flex justify-content-center py-1">
                                  <div className="d-flex justify-content-between w-100 rounded align-items-center">
                                    <div>
                                      <button
                                        className="border-0 bg-transparent text-warning fs-4"
                              ...
                              <div
                                className="text-white text-center fs-2 border-0 bg-transparent"
                                onClick={() => send(data)}
                              >
                                Add to Shopping Bag
                              </div>
                          ...
                          <div className="bg-white text-center bottom-0 position-absolute w-100">
                            <a
                              href="#"
                              style={{
                                textDecoration: "none",
                    ...
                    <div className="cart-footer">
                      {carts.find((cart_data) => cart_data?.id === data?.id) ? (
                        <div className="d-flex justify-content-center py-1">
                          <div
                            className="d-flex justify-content-around w-100 rounded align-items-center"
                            style={{ backgroundColor: "#ff8182" }}
                          >
                            <div>
                              <button
                                className="border-end border-0 bg-transparent text-white fs-4"
                                onClick={() => deleteItem(data)}
                              >
                                -
                              </button>
                            ...
                            <div>
                              <button
                                className="border-start border-0 bg-transparent text-white fs-4"
                                onClick={() => send(data)}
                              >
                                +
                              </button>
                        ...
                        <div className="d-flex justify-content-center py-1">
                          <div className="d-flex justify-content-between">
                            <div>
                              <button
                                onClick={() => send(data)}
                                className="text-danger px-4 py-2 border-1 bg-transparent rounded"
                              >
